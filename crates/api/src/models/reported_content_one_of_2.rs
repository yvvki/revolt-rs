...
/// ReportedContentOneOf2 : Report a user



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ReportedContentOneOf2 {
    #[serde(rename = "type")]
...
impl ReportedContentOneOf2 {
    /// Report a user
    pub fn new(r#type: RHashType, id: String, report_reason: crate::models::UserReportReason) -> ReportedContentOneOf2 {

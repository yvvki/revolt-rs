...
/// InviteResponseOneOfServerIcon : Attachment for server icon



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct InviteResponseOneOfServerIcon {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl InviteResponseOneOfServerIcon {
    /// Attachment for server icon
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> InviteResponseOneOfServerIcon {

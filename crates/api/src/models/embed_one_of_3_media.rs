...
/// EmbedOneOf3Media : ID of uploaded autumn file



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct EmbedOneOf3Media {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl EmbedOneOf3Media {
    /// ID of uploaded autumn file
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> EmbedOneOf3Media {
        EmbedOneOf3Media {
            _id,
            tag,
            filename,

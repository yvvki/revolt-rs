...
/// SnapshotContentOneOf1 : Representation of a server on Revolt



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct SnapshotContentOneOf1 {
    #[serde(rename = "_type")]
    pub _type: Type,
    /// Unique Id
    #[serde(rename = "_id")]
...
impl SnapshotContentOneOf1 {
    /// Representation of a server on Revolt
    pub fn new(_type: Type, _id: String, owner: String, name: String, channels: Vec<String>, default_permissions: i64) -> SnapshotContentOneOf1 {

...
/// InviteResponseOneOfServerBanner : Attachment for server banner



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct InviteResponseOneOfServerBanner {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl InviteResponseOneOfServerBanner {
    /// Attachment for server banner
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> InviteResponseOneOfServerBanner {

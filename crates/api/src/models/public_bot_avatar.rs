...
/// PublicBotAvatar : Profile Avatar



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct PublicBotAvatar {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl PublicBotAvatar {
    /// Profile Avatar
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> PublicBotAvatar {
        PublicBotAvatar {
            _id,
            tag,
            filename,

...
/// ChannelOneOf2Icon : Custom icon attachment



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct ChannelOneOf2Icon {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl ChannelOneOf2Icon {
    /// Custom icon attachment
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> ChannelOneOf2Icon {
        ChannelOneOf2Icon {
            _id,
            tag,
            filename,

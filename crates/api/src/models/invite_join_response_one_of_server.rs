...
/// InviteJoinResponseOneOfServer : Server we are joining



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct InviteJoinResponseOneOfServer {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl InviteJoinResponseOneOfServer {
    /// Server we are joining
    pub fn new(_id: String, owner: String, name: String, channels: Vec<String>, default_permissions: i64) -> InviteJoinResponseOneOfServer {

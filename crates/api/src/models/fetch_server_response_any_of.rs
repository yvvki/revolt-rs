...
/// FetchServerResponseAnyOf : Representation of a server on Revolt



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FetchServerResponseAnyOf {
...
impl FetchServerResponseAnyOf {
    /// Representation of a server on Revolt
    pub fn new(channels: Vec<String>, _id: String, owner: String, name: String, default_permissions: i64) -> FetchServerResponseAnyOf {

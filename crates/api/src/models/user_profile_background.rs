...
/// UserProfileBackground : Background visible on user's profile



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct UserProfileBackground {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl UserProfileBackground {
    /// Background visible on user's profile
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> UserProfileBackground {

...
/// ServerBanner : Banner attachment
...
impl ServerBanner {
    /// Banner attachment
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> ServerBanner {
        ServerBanner {
            _id,
            tag,
            filename,

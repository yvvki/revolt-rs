...
/// FetchBotResponseUser : User object



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct FetchBotResponseUser {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
    /// Username
...
impl FetchBotResponseUser {
    /// User object
    pub fn new(_id: String, username: String, discriminator: String) -> FetchBotResponseUser {

...
/// InviteResponseOneOfUserAvatar : Avatar of the user who created the invite



#[derive(Clone, Debug, PartialEq, Default, Serialize, Deserialize)]
pub struct InviteResponseOneOfUserAvatar {
    /// Unique Id
    #[serde(rename = "_id")]
    pub _id: String,
...
impl InviteResponseOneOfUserAvatar {
    /// Avatar of the user who created the invite
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> InviteResponseOneOfUserAvatar {

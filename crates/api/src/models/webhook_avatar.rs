...
/// WebhookAvatar : The avatar of the webhook
...
impl WebhookAvatar {
    ...
    pub fn new(_id: String, tag: String, filename: String, metadata: crate::models::FileMetadata, content_type: String, size: i32) -> WebhookAvatar {
        WebhookAvatar {
            _id,
            tag,
            filename,
